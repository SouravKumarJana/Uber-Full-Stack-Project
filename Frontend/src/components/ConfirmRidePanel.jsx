...
const ConfirmRidePanel = (props)=>{
    return(
        <div>
            ...
            <h3 className='text-2xl font-semibold mb-6 mt-5 '>Confirm Your Ride</h3>
            ...
            <div className="flex flex-col justify-between items-center  " >
                ...
                <button onClick={()=>{
                    ...
                    props.setConfirmRidePanel(false)
                    props.createRide()
                }} className="w-full bg-green-700 p-2 text-white font-semibold text-xl rounded-lg mt-5">Confirm</button>
            </div>
